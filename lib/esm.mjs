...
export async function resolve(specifier, context, defaultResolve) {
  ...
  return addShortCircuitFlag(async () => {
    ...
    return entrypointFallback(() => nodeInternalDefaultResolve(specifier, context));
  });
}
...
export async function load(url, context, defaultLoad) {
  return addShortCircuitFlag(async () => {
    ...
    const format = context.format ?? (await getFormat(url, context, nodeInternalDefaultGetFormat)).format;
