  ...
  switch (request) {
    ...
    case 'webpack-dev-server':
      if (!parent.path.includes('@rspack/dev-server')) {
        request = rspackDevServerMainPath;
      }
      break;
    ...
    case './webpack/plugins/profiling-plugin':
      request = require.resolve('./next-profiling-plugin');
      break;
    case './next-drop-client-page-plugin':
    case './webpack/plugins/next-drop-client-page-plugin':
      if (!parent.path.includes('rspackify')) {
        request = require.resolve('./next-drop-client-page-plugin');
      }
      break;
    case './webpack/plugins/app-build-manifest-plugin':
      request = require.resolve('./next-app-build-manifest-plugin');
      break;
    case './webpack/plugins/flight-manifest-plugin':
      request = require.resolve('./next-flight-manifest-plugin');
      break;
    case './webpack/plugins/react-loadable-plugin':
      request = require.resolve('./next-react-loadable-plugin');
      break;
    case './webpack/plugins/next-font-manifest-plugin':
      request = require.resolve('./next-font-manifest-plugin');
      break;
    case '../../build/webpack/plugins/nextjs-require-cache-hot-reloader':
    case '../build/webpack/plugins/nextjs-require-cache-hot-reloader':
    case './webpack/plugins/nextjs-require-cache-hot-reloader':
      request = require.resolve('./nextjs-require-cache-hot-reloader');
      break;
    case './webpack/plugins/flight-client-entry-plugin':
      request = require.resolve('./next-flight-client-entry-plugin');
      break;
    case './webpack/plugins/next-types-plugin':
      request = require.resolve('./next-types-plugin');
      break;
  }
